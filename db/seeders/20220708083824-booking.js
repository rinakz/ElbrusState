...
module.exports = {
  async up (queryInterface, Sequelize) {
    ...
    await queryInterface.bulkInsert('Bookings', [
      ...
      { user_id: 1, room_id: 14, type_id: 15, day_id: 5, time_start: '17:00', time_end: '18:30', comment: 'выпускной песцов'},
      { user_id: 1, room_id: 14, type_id: 15, day_id: 5, time_start: '18:30', time_end: '19:30', comment: 'PIZZA PARTY!'},
